    ...
    try:
        ...
        if controller.click_text("MY BATTERY CHARGE"):
            ...
            if text_present:
                ...
                fail_log("My Battery Charge screen and details not displayed", "005", img_service)
...
def Demo_Mode_007():
    try:
        ...
        if controller.click_text("Alerts"):
            ...
            fail_log("Alerts tab not displayed", "007", img_service)
...
def Demo_Mode_009():
    try:
        ...
        if compare_with_expected_crop("Images/Setting_Screen.png"):
            ...
            fail_log("Setting Screen options not present", "009", img_service)
