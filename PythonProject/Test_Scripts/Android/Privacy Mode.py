    ...
    try:
        if app_login_setup():
            ...
            if controller.find_img("Icons/lock_icon.png", 0.75):
                ...
                fail_log("Remote lock unlock unavailable", "005", img_service)
    ...
    try:
        if app_login_setup():
            ...
            if compare_with_expected_crop("Icons/Remote_Lock_Grey.png", 0.9):
                ...
                fail_log("Remote lock unlock failed to be disabled when privacy mode activated", "006", img_service)
    ...
    try:
        if app_login_setup():
            ...
            if compare_with_expected_crop("Images/cabin_comfort_disabled.png"):
                ...
                fail_log("Cabin comfort not disabled in privacy mode", "008", img_service)
    ...
    try:
        if app_login_setup():
            ...
            if compare_with_expected_crop("Images/battery_charge_disabled.png"):
                ...
                fail_log("My battery charge service not disabled in privacy mode", "009", img_service)
    ...
    try:
        if app_login_setup():
            ...
            if not controller.d(resourceId="uk.co.bentley.mybentley:id/imageButton_layout_map_button").exists:
                ...
                fail_log("Find my car icon displayed when privacy mode activated", "010", img_service)
            ...
            for i in range(len(driver_icon_bounds)):
                ...
                if controller.is_text_present("PLAN ROUTE"):
                    fail_log("Car location marker still shown in privacy mode", "010", img_service)
...
def Privacy_Mode_012():
    try:
        ...
        #         else:
        #             fail_log("Remote parking failed to be disabled when privacy mode activated", "012", img_service)
        #
    ...
    try:
        if app_login_setup():
            ...
            if compare_with_expected_crop("Images/car_statistics_disabled.png"):
                ...
                fail_log("My car statistics service not disabled in remote screen", "013", img_service)
    ...
    try:
        if app_login_setup():
            ...
            if controller.is_text_present("Graphical view"):
                ...
                fail_log("My car statistics screen not accessible", "014", img_service)
            controller.click_by_resource_id("uk.co.bentley.mybentley:id/tab_vehicle_dashboard")

    except Exception as e:
        error_log(e, "014", img_service)

def Privacy_Mode_015():
    try:
