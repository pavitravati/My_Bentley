...
def Service_Management_006():
    try:
        ...
        if controller.click_text("MY CAR STATISTICS") and controller.is_text_present("Function disabled"):
...
def Service_Management_007():
    try:
        ...
        if controller.click_text("MY BATTERY CHARGE") and controller.is_text_present("Function disabled"):
            log("Battery charge successfully disabled")
        else:
            fail_log("Battery charge failed to disable", "007", img_service)
