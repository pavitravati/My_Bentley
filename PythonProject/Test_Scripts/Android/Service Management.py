...
def Service_Management_002():
    ...
    try:
        if app_login_setup():
            ...
            if not compare_with_expected_crop("Images/lock_car_service_disabled.png"):
                ...
                fail_log("Lock My Car service cannot be toggled as it is disabled", "002", img_service)
...
def Service_Management_003():
    ...
    try:
        if app_login_setup():
            ...
            if not compare_with_expected_crop("Images/find_car_service_disabled.png"):
                ...
                fail_log("Find car service cannot be toggled as service is disabled", "003", img_service)
...
def Service_Management_004():
    ...
    try:
        if app_login_setup():
            ...
            if not compare_with_expected_crop("Images/car_status_service_disabled.png"):
                ...
                fail_log("My Car Status service cannot be toggled as service is disabled", "004", img_service)
    ...
    try:
        if vehicle_type == "phev":
            if app_login_setup():
                ...
                if not compare_with_expected_crop("Images/cabin_comfort_service_disabled.png"):
                    ...
                    fail_log("My Cabin Comfort service cannot be toggled as service is disabled", "005", img_service)
    ...
    try:
        if vehicle_type == "phev":
            if app_login_setup():
                ...
                if not compare_with_expected_crop("Images/car_statistics_service_disabled.png"):
                    ...
                    fail_log("My Car Statistics service cannot be toggled as service is disabled", "006", img_service)
    ...
    try:
        if vehicle_type == "phev":
            if app_login_setup():
                ...
                if not compare_with_expected_crop("Images/battery_charge_service_disabled.png"):
                    ...
                    fail_log("My Battery Charge cannot be toggled as service is disabled", "007", img_service)
    ...
    try:
        if country == "eur":
            if app_login_setup():
                ...
                if not compare_with_expected_crop("Images/theft_alert_service_disabled.png"):
                    ...
                    fail_log("Theft alert cannot be toggled as service is disabled", "008", img_service)
        else:
        ...
        if country == "eur":
            if vehicle_type == "ice":
                if app_login_setup():
                    ...
                    if not compare_with_expected_crop("Images/activate_heating_service_disabled.png"):
                        ...
                        fail_log("Activate heating cannot be toggled as service is disabled", "012", img_service)
