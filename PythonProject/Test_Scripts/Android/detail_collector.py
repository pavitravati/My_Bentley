...
def get_details():
    ...
    #     while not controller.wait_for_text_that_contains("(Build: "):
...
def get_device_details():
    ...
    sleep(0.5)
    if controller.click_by_image("Icons/settings_search.png") or controller.click_by_image("Icons/settings_search_light.png"):
